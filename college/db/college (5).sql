...
--
-- 表的结构 `coll_article_combine`
--

CREATE TABLE IF NOT EXISTS `coll_article_combine` (
  `id` int(15) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(50) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(3000) NOT NULL DEFAULT '' COMMENT '内容',
  `link` varchar(255) NOT NULL DEFAULT '' COMMENT '链接',
  `thumb_url` varchar(255) NOT NULL DEFAULT '' COMMENT '图片URL',
  `content_id` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT '内容ID',
  `comment_id` int(30) unsigned NOT NULL DEFAULT '0' COMMENT '评论ID',
  `add_time` int(13) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  `start_time` int(13) unsigned NOT NULL DEFAULT '0' COMMENT '开始时间',
  `end_time` int(13) unsigned NOT NULL DEFAULT '0' COMMENT '结束时间',
  `add_man` varchar(20) NOT NULL DEFAULT '' COMMENT '添加人',
  `is_show` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否显示',
  PRIMARY KEY (`id`),
  KEY `title` (`title`,`add_time`),
  KEY `content_id` (`content_id`,`comment_id`),
  KEY `is_show` (`is_show`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='临时数据表' AUTO_INCREMENT=33 ;

--
-- 转存表中的数据 `coll_article_combine`
--

INSERT INTO `coll_article_combine` (`id`, `title`, `content`, `link`, `thumb_url`, `content_id`, `comment_id`, `add_time`, `start_time`, `end_time`, `add_man`, `is_show`) VALUES
(1, '欢迎加入AHA-BJA国际高中部', '在这里，我们将提供中英双母语的教学环境：孩子们将同BJA的优秀学生一同上课，利用BJU的资源展开适合自己的AP学习计划，课后将享受量身定做的英文补习计划，以及，特设的中文辅导课程。在这里，孩子们将有专门的老师辅导日常的学习和生活，将享受当地社区所提供的家庭般的关怀。可以说，我们，将为国际高中部的孩子们提供一个在外的家，一个可以随时回去的地方。', '', '/Static/img/BJA2-2-128x96.jpg', 1, 0, 1465516800, 0, 0, '', 1),
(2, '2016年AHA家庭音乐节', '本届AHA的家庭音乐节将于本周四（3月24日）下午2：45分正式拉开序幕。我们诚邀各位家长前来参加我们的音乐节，一起欣赏孩子们和部分老师的精彩演出。有意前来的家长，请于3月24日上午10点前同各班班主任预约，我们将为您预留好坐席。&lt;br&gt;\r\n                                    AHA期待您的到来！让我们一同见证孩子们的成长！', '', '/Static/img/603570180-128x96.jpg', 1, 0, 1458691200, 0, 0, '', 1),
(3, '在家书院9岁啦', '18日下午三时许，窗外烟雨蒙蒙略透一丝寒意，伴随下课铃响，在家书院孩子们欢聚一堂，纷纷拿出精心准备的材料，以班级为单位开始蛋糕DIY。今天是什么日子呢？原来我们AHA今天9岁了。&lt;br&gt;', '', '/Static/img/20160205lkh194540.jpg', 1, 0, 1458259200, 0, 0, '', 1),
(4, '我们的节日——端午节', '农历五月初五，是中国的传统节日——端午。对于双语并重的AHA而言，不仅要庆祝西方的感恩节、圣诞节，中国意蕴浓厚的端午节自然也要隆重纪念一番了。', '', '/Static/img/19-128x96.jpg', 1, 0, 1435017600, 0, 0, '', 1),
(5, '2015年6月15-19日IOWA TEST', 'IOWA是一系列由美国爱荷华州立大学教育学院所编撰的标准测试，主要测试从幼稚园大班到12年级学生在各领域的学习情况，包括单词、词汇分析、阅读理解能力、听力、英文（语言能力）、数学、社会学和自然科学。\r\n                                    &lt;br&gt;', '', '/Static/img/211.jpg', 1, 0, 1435017600, 0, 0, '', 1),
(6, '喜爱BJU鲍琼斯大学的八条理由', '今天中国的父母对于子女的教育常常很纠结，留学还是不留学？去哪个国家留学？学费会不会成为家庭的经济负担？孩子独自在外学习生活，会不会学坏？将来学成归来会不会成为“海待”？\r\n                                    &lt;br&gt;', '', '/Static/img/bju-logo-128x96.png', 1, 0, 1435017600, 0, 0, '', 1),
(7, '第二届AHA家庭音乐会重磅回归', '君忆否，自去年AHA拉开了家庭音乐会的序幕，这便成为书院的众多传统之一而延续了下来。今年，AHA家庭音乐会在我们的期待之下，终于归来了！\r\n                                    &lt;br&gt;\r\n                                    4月16日的下午4点15分开始，一场音乐的盛宴在书院三楼揭开帷幕。同第一届音乐会不同的是，本届音乐会邀请了大约50名家长前来。台上的孩子们全情投入，台下的家长们也乐在其中。', '', '/Static/img/528758095-128x96.jpg', 1, 0, 1429488000, 0, 0, '', 1),
(8, '欢迎加入AHA-BJA国际高中部', '在这里，我们将提供中英双母语的教学环境：孩子们将同BJA的优秀学生一同上课，利用BJU的资源展开适合自己的AP学习计划，课后将享受量身定做的英文补习计划，以及，特设的中文辅导课程。在这里，孩子们将有专门的老师辅导日常的学习和生活，将享受当地社区所提供的家庭般的关怀。可以说，我们，将为国际高中部的孩子们提供一个在外的家，一个可以随时回去的地方。', '', '/Static/img/BJA2-2-128x96.jpg', 1, 0, 1465516800, 0, 0, '', 1),
(9, '2016年5月露营周', 'AHA， 或者说“啊哈”(听到大家都这样称呼你，不知道我是否可以把这个作为你的诸多昵称之一)，近来听说你去了巽寮湾露营。故地重游，是否多了些不一样的小故事呢？', '', '/Static/img/p10.jpg', 1, 0, 1465257600, 0, 0, '', 1),
(10, '在家书院英文“冬季学校”（2016年1月18-29日）', '强劲的英文环境 两周的学习中，孩子们每天都将浸泡在英文环境中练习听力和对话。外教和中国老师一起配搭，帮助孩子更快成长。', '', '', 1, 0, 1451865600, 0, 0, '', 1),
(11, '美国大学探秘之旅', '还在学业路上奋斗的你，是否也会偶尔放下手中疾飞的笔，任思绪飞扬，憧憬那看似遥不可及却又近在咫尺的大学校园？听了那么多的大学宣讲课程，你是否想去大洋彼岸亲自揭开她的神秘面纱，一睹芳容，亲见她的丰富多彩？面对扑面而来的大学简介时，你是否会感到迷茫和不知所措？ ', '', '', 1, 0, 1451865600, 0, 0, '', 1),
(12, 'AHA-BJU体系2015年度第五期教师培训开始报名啦', '亲爱的弟兄姊妹，你是否疑惑过现行的教育体制？你是否想成为一个不同的教育者？你是否想同同侪们分享你独特的教育思考？你是否想带领孩子们一起成长？如果你都曾有过这些想法，如果你现在仍在思考这些问题，欢迎你加入我们。', '', '', 1, 0, 1438387200, 0, 0, '', 1),
(13, '2015年夏AHA在家教育家长培训课程', '您是不是打算在家教育孩子，却没有任何头绪和方向，或是苦于找不到好的教材，或是看不见前面的方向，或是找不到志同道合的伙伴，或是有太多的或是……', '', '', 1, 0, 1437350400, 0, 0, '', 1),
(14, '在家书院2015毕业晚会', '学校的持续发展以及学生的健康成长，都离不开专业化的学校管理。 中国缺乏专业校长人才，这次培训班为校长们提供一次非常难得的系统培训， 手把手教您怎样做校长，帮助您建立合乎国际学校标准的学校管理体系。 欢迎现任的学校管理者，以及有意成为校长的教育人士报名参加。', '', '/Static/img/p1.jpg', 1, 0, 1435104000, 0, 0, '', 1),
(15, '欢迎参加在家书院AHA英文夏令营，时间2015年7月13日-8月14日', '全日制国际学校“在家书院”今年暑假照例开办“夏季学校”，让您的孩子体会不一样的英文学习。', '', '', 1, 0, 1435017600, 0, 0, '', 1),
(16, 'AHA讲座通知——留学美国实用常识，大学留学的选择', '本周六3月28日上午10：30分，在家书院邀请美国纽约蓝天教育服务负责人、纽约乃亚克大学招生代表韩梅女士来校，就如何出国留学等问题进行讨论交流。', '', '', 1, 0, 1427241600, 0, 0, '', 1);
...
INSERT INTO `coll_news` (`news_id`, `title`, `thumb_url`, `link`, `content`, `content_id`, `comment_id`, `add_time`, `start_time`, `end_time`, `add_man`, `is_show`) VALUES
(1, '欢迎加入AHA-BJA国际高中部', '/Static/img/BJA2-2-128x96.jpg', '', '在这里，我们将提供中英双母语的教学环境：孩子们将同BJA的优秀学生一同上课，利用BJU的资源展开适合自己的AP学习计划，课后将享受量身定做的英文补习计划，以及，特设的中文辅导课程。在这里，孩子们将有专门的老师辅导日常的学习和生活，将享受当地社区所提供的家庭般的关怀。可以说，我们，将为国际高中部的孩子们提供一个在外的家，一个可以随时回去的地方。', 1, 0, 1465516800, 0, 0, '', 1),
