...
CREATE TABLE IF NOT EXISTS `coll_notice` (
  ...
  `noti_title` varchar(50) NOT NULL DEFAULT '' COMMENT '新闻标题',
  `noti_content` text NOT NULL COMMENT '新闻内容',
...
INSERT INTO `coll_notice` (`notice_id`, `noti_title`, `noti_content`, `link`, `thumb_url`, `type_id`, `comment_id`, `add_time`, `start_time`, `end_time`, `add_man`, `is_show`) VALUES
