...
CREATE TABLE IF NOT EXISTS `coll_article` (
  ...
  `arti_title` varchar(50) NOT NULL COMMENT '文章标题',
  `arti_content` text NOT NULL COMMENT '文章内容',
  `author` varchar(20) NOT NULL DEFAULT '' COMMENT '作者',
  `arti_add_time` int(20) unsigned NOT NULL DEFAULT '0' COMMENT '文章发布时间',
  `type_id` mediumint(7) NOT NULL DEFAULT '0' COMMENT '文章类型（1新闻；2公告）',
  `img_url` varchar(255) NOT NULL DEFAULT '' COMMENT '文章图片',
  `arti_is_show` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '是否显示',
  PRIMARY KEY (`article_id`,`type_id`),
  UNIQUE KEY `video_id` (`article_id`),
  KEY `article_title` (`arti_title`)
...
INSERT INTO `coll_article` (`article_id`, `arti_title`, `arti_content`, `author`, `arti_add_time`, `type_id`, `img_url`, `arti_is_show`) VALUES
(1, '欢迎加入AHA-BJA国际高中部', '在这里，我们将提供中英双母语的教学环境：孩子们将同BJA的优秀学生一同上课，利用BJU的资源展开适合自己的AP学习计划，课后将享受量身定做的英文补习计划，以及，特设的中文辅导课程。在这里，孩子们将有专门的老师辅导日常的学习和生活，将享受当地社区所提供的家庭般的关怀。可以说，我们，将为国际高中部的孩子们提供一个在外的家，一个可以随时回去的地方。', 'clay_Li', 1234456778, 2, 'images/pro41.png', 1),
(2, '5种方法提高你的时间利用率', '研究显示，小企业主认为时间是一个更有价值的资产比电脑，手机和公司的办公室或店面。', 'clay_Li', 4294967295, 3, 'images/pro42.png', 1),
(3, '5种方法提高你的时间利用率', '研究显示，小企业主认为时间是一个更有价值的资产比电脑，手机和公司的办公室或店面。', 'clay_Li', 4294967295, 3, 'images/pro43.png', 1),
(4, '5种方法提高你的时间利用率', '研究显示，小企业主认为时间是一个更有价值的资产比电脑，手机和公司的办公室或店面。', 'clay_Li', 3456789236, 3, 'images/pro44.png', 1),
(5, '5种方法提高你的时间利用率', '研究显示，小企业主认为时间是一个更有价值的资产比电脑，手机和公司的办公室或店面。', 'clay_Li', 3456789987, 3, 'images/pro45.png', 1),
(6, '5种方法提高你的时间利用率', '研究显示，小企业主认为时间是一个更有价值的资产比电脑，手机和公司的办公室或店面。', 'clay_Li', 4294967295, 3, 'images/pro46.png', 1);
...
--
-- 表的结构 `coll_article_temp`
--

CREATE TABLE IF NOT EXISTS `coll_article_temp` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='临时数据表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `coll_article_temp`
--

INSERT INTO `coll_article_temp` (`id`, `title`, `content`, `link`, `thumb_url`, `add_time`) VALUES
(1, '', '', '', '', 0);
